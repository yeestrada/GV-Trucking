export const landingCopy = {
    "en": {
            ...
            "items": [
                {
                    ...
                    "body": "When we accept an order, we plan the run and follow through—no overbooking."
                },
                {
                    "title": "Secure handling",
                    "body": "Proper straps, chains, and checks so open-deck freight stays protected."
                },
                {
                    "title": "On-time focus",
                    "body": "Clear ETAs and proactive updates from people who know the truck and the route."
                }
            ]
        },
        "services": {
            ...
            "items": [
                {
                    "title": "Flatbed loads",
                    "body": "Equipment, steel, building materials, and other open-deck freight that needs space and securement."
                },
                {
                    "title": "Regional & long-haul",
                    "body": "Planned lanes with disciplined communication from pickup through delivery."
                },
                {
                    "title": "Dedicated attention",
                    "body": "A focused two-truck operation means your load is not lost in a massive network."
                }
            ]
        },
        "about": {
        ...
        "whyUs": {
            ...
            "items": [
                {
                    "title": "Accountable capacity",
                    "body": "We only take what we can move well."
                },
                {
                    "title": "Securement discipline",
                    "body": "Open-deck freight done the right way."
                },
                {
                    "title": "Direct communication",
                    "body": "Talk to people who know the status."
                },
                {
                    "title": "Broker-ready",
                    "body": "Clear answers on equipment, timing, and coverage."
                },
                {
                    "title": "Protect your freight",
                    "body": "Careful handling from yard to destination."
                },
                {
                    "title": "No runaround",
                    "body": "Straightforward dispatch without layers of delay."
                }
            ]
        },
        "midCta": {
            ...
            "items": [
                {
                    ...
                    "a": "We specialize in flatbed. Tell us dimensions, weight, and commodity so we can confirm fit and securement needs."
                },
                {
                    "q": "How do I request capacity?",
                    "a": "Use the form on this page or email dispatch with origin, destination, commodity, and pickup window. We respond as quickly as possible."
                },
                {
                    "q": "Do you take brokered freight?",
                    "a": "Yes. We work with brokers and shippers who need a reliable flatbed partner for assigned loads."
                },
                {
                    "q": "How is communication handled?",
                    "a": "Direct dispatch contact—status updates from people who know the truck, the route, and the load."
                }
            ]
        },
        "cta": {
    ...
    "es": {
        ...
        "trust": {
            ...
            "items": [
                {
                    "title": "Capacidad confiable",
                    "body": "Cuando aceptamos una orden, planificamos el viaje y lo cumplimos—sin sobrecupo."
                },
                {
                    "title": "Manejo seguro",
                    "body": "Correas, cadenas y revisiones para que la carga abierta viaje protegida."
                },
                {
                    "title": "Enfoque a tiempo",
                    "body": "ETAs claros y actualizaciones de quien conoce el camión y la ruta."
                }
            ]
        },
        "services": {
            ...
            "items": [
                {
                    "title": "Cargas flatbed",
                    "body": "Equipo, acero, materiales de construcción y otra carga abierta que necesita espacio y amarre."
                },
                {
                    "title": "Regional y larga distancia",
                    "body": "Rutas planificadas con comunicación disciplinada de origen a destino."
                },
                {
                    "title": "Atención dedicada",
                    "body": "Una operación de dos camiones significa que tu carga no se pierde en una red enorme."
                }
            ]
        },
        "about": {
        ...
        "whyUs": {
            ...
            "items": [
                {
                    "title": "Capacidad responsable",
                    "body": "Solo tomamos lo que podemos mover bien."
                },
                {
                    "title": "Disciplina de amarre",
                    "body": "Carga abierta hecha como debe ser."
                },
                {
                    "title": "Comunicación directa",
                    "body": "Hablas con quien conoce el estado."
                },
                {
                    "title": "Listos para brokers",
                    "body": "Respuestas claras de equipo, tiempos y cobertura."
                },
                {
                    "title": "Protege tu flete",
                    "body": "Manejo cuidadoso del patio al destino."
                },
                {
                    "title": "Sin rodeos",
                    "body": "Despacho directo, sin capas de demora."
                }
            ]
        },
        "midCta": {
        ...
        "faq": {
            ...
            "items": [
                {
                    "q": "¿Qué equipo operan?",
                    "a": "Nos especializamos en flatbed. Indica dimensiones, peso y mercancía para confirmar aptitud y amarre."
                },
                {
                    "q": "¿Cómo solicito capacidad?",
                    "a": "Usa el formulario de esta página o escribe a despacho con origen, destino, mercancía y ventana de recolección."
                },
                {
                    "q": "¿Toman flete de brokers?",
                    "a": "Sí. Trabajamos con brokers y shippers que necesitan un socio flatbed confiable para cargas asignadas."
                },
                {
                    "q": "¿Cómo manejan la comunicación?",
                    "a": "Contacto directo con despacho—actualizaciones de quien conoce el camión, la ruta y la carga."
                }
            ]
        },
        "cta": {
